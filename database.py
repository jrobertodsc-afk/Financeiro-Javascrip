...
def listar_pagamentos_autorizados(data_de=None, data_ate=None, empresa=None):
    if USE_SUPABASE:
        try:
            ...
            print(f"Erro Supabase (listar_pagamentos): {e}")
...
def salvar_nota(dados):
    ...
    if USE_SUPABASE:
        try:
            ...
            print(f"Erro Supabase (salvar_nota): {e}")
...
def listar_notas(status=None, empresa=None, busca=None):
    if USE_SUPABASE:
        try:
            ...
            print(f"Erro Supabase (listar_notas): {e}")
...
def atualizar_status_nota(nota_id, status):
    ...
    if USE_SUPABASE:
        try:
            ...
            print(f"Erro Supabase (atualizar_status): {e}")
    conn = _get_local_conn()
...
def salvar_adiantamento(dados):
    if USE_SUPABASE:
        try:
            ...
            print(f"Erro Supabase (adiantamento): {e}")
...
def listar_adiantamentos(status=None, empresa=None, busca=None):
    if USE_SUPABASE:
        try:
            ...
            print(f"Erro Supabase (listar adiantamentos): {e}")
            return []
...
def listar_fornecedores(busca=None, ativo_only=False):
    if USE_SUPABASE:
        try:
            ...
            print(f"Erro Supabase (listar fornecedores): {e}")
            return []
